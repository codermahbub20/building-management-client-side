...
const About = () => {
    return (
        <div>
            <h1 className="sm:text-4xl md:text-5xl font-rancho font-medium text-center">About  -  the - building</h1>
            <div className=" md:mt-5 md:p-10 gap-5 lg:flex">
                <div className="space-y-4 flex-1 lg:justify-end  flex-row-reverse items-center">
                    <h1 className="text-4xl font-rancho font-semibold">More About For Our Building.......</h1>
